...
<!---<script type="text/javascript">
 ...
 animatedcollapse.addDiv('COVER-STORY', 'fade=0,speed=400,group=pets')
animatedcollapse.addDiv('FEATURE-ARTICLES', 'fade=0,speed=400,group=pets,persist=1,hide=1')
animatedcollapse.addDiv('TAKING-STOCK', 'fade=0,speed=400,group=pets,hide=1')
animatedcollapse.addDiv('front-line', 'fade=0,speed=400,group=pets,hide=1')
animatedcollapse.addDiv('FRONT-ROW', 'fade=0,speed=400,group=pets,hide=1')
animatedcollapse.addDiv('FOREFRONT', 'fade=0,speed=400,group=pets,hide=1')
animatedcollapse.addDiv('CLASS-NOTES', 'fade=0,speed=400,group=pets,hide=1')
animatedcollapse.addDiv('BUSINESS-PROFILE', 'fade=0,speed=400,group=pets,hide=1')
...
<cfset variables.captcha = #articlesObject.getCaptcha()# />
<cf_cryp type="en" string="#variables.captcha#" key="#application.key#">
<!---*** end ***--->
...
<cfif StructKeyExists(form,"Action-A")>
  ...
  <cfparam name="attributes.captcha_text" default="" >
  <cfparam name="attributes.captcha_user" default="" >
  <cfparam name="attributes.commenttext" default="" >
  <cfparam name="attributes.email" default="" >
  <cfparam name="attributes.gradyear" default="" >
  <!---insert comment --->
  <cfif trim(attributes.captcha_text) eq trim(attributes.captcha_user)>
  <cftry>
...
<!--- <cfmessagebox name="mymessagebox01" type="prompt"  
        ...
        labelOK="This is OK" labelCANCEL="Cancel this"  
           callbackhandler="onfinish" multiline="true"/>  --->
 <div id="message_box"><p>YOUR COMMENT DID NOT SUBMIT - There was an error in the verification image text.<br />Please re-enter your comment below</p></div>
      ...
      <cfoutput>
        <cfif articlepagecount.recordcount neq 1 OR articlepagecount.recordcount neq attributes.page>
          ...
          <cfif val(attributes.page) gt 1>
            ...
            <a href="/article/?id=#attributes.ID#&page=#variables.previouspage#<cfif attributes.main neq attributes.ID>&main=#val(attributes.main)#</cfif>">&lt; Previous&nbsp;&nbsp;</a>
          </cfif>
          <cfloop query="articlepagecount">
            ...
            <cfif val(articlepagecount.currentrow) eq val(attributes.page)>
              ...
              <cfelse>
              <a href="/article/?id=#attributes.ID#&page=#articlepagecount.currentrow#<cfif attributes.main neq attributes.ID>&main=#val(attributes.main)#</cfif>">#articlepagecount.currentrow#</a>&nbsp;&nbsp;
            </cfif>
          </cfloop>
          <cfif articlepagecount.recordcount neq attributes.page and articlepagecount.recordcount neq 0>
            ...
            <a href="/article/?id=#attributes.ID#&page=#variables.nextpage#<cfif attributes.main neq attributes.ID>&main=#val(attributes.main)#</cfif>">Next &gt;</a>
          </cfif>
          </span>
        </cfif>
      </cfoutput>
      ...
      <div id="submission">
        ...
        <ul>
          <li>
            ...
            <cfinput class="inp-2" name="commentname" type="text" id="Name" required="yes" message="Please enter your name"/>
          </li>
          <li>
          ...
          <li><cfoutput>
                      ...
                      <input type="hidden" name="captcha_text" value="#cryp.value#" />
                      <p align="center" style="margin-bottom:15px">Verification image<br /><cfimage action="captcha" fontSize="17" width="224" height="36" text="#variables.captcha#" 
    fonts="Arial,Verdana,Courier New"></p><p><label class="required" for="Verification">Verification text:</label><cfinput class="inp-2" name="captcha_user" type="text" id="captcha_user" required="yes" message="Please enter the text from the verification image."/></p></cfoutput>
          </li>
        </ul>
        <p align="center">
        ...
        <cfif gettabcontent.recordcount neq 0>
          <cfif val(attributes.classnotes) eq 0>
            <cfoutput query="getmain">
              ...
              <a href="/article/?id=#getmain.articleID#">#getmain.headline#</a>
              </li>
            </cfoutput>
            <cfelse>
            <!---           Handle class notes --->
          ...
          <cfoutput>
            <cfif val(attributes.classnotes) eq 0>
              <cfloop query="gettabcontent">
                ...
                <a href="/article/?id=#gettabcontent.subarticleID#&main=#getmain.articleID#">#gettabcontent.headline#</a>
                </li>
              </cfloop>
              <cfelse>
              ...
              <cfloop query="gettabcontent">
                ...
                <a href="/article/?id=#gettabcontent.articleID#&classnotes=#val(attributes.classnotes)#">#gettabcontent.headline#</a>
                </li>
              </cfloop>
            </cfif>
          </cfoutput>
