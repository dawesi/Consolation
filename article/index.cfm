...
<!---play video --->
<link rel="stylesheet" type="text/css" href="http://business.nd.edu/shadowbox/shadowbox.css">
<!--- end video --->
  ...
  <div id="content-2"> 
    ...
    <cfif val(attributes.id) eq 0 or val(attributes.issueid) eq 0 or variables.thisarticletypeID eq 9>
      ...
      <div id="front"> <cfoutput>
          ...
          <cfif len(trim(getthisarticle.author))>
          <p class="byline">by #getthisarticle.author#</p>
          </cfif>
          ...
          <cfif val(getthisarticle.content_id) neq 0>
            ...
            <cfif trim(getEktronInfo.StreamFileHq) neq ''>
           <p class="bluesubhead" style="text-align: center"><a class="player" rel="shadowbox; height=457; width=768;" href="http://www.youtube.com/embed/#getEktronInfo.StreamFileHq#?wmode=Opaque&autoplay=1">PLAY VIDEO</a></p>
            <cfelse>
...
This site's content is best viewed with Flash        <br />
        ...
        <cfif trim(getthisarticle.pagecopy) eq ''>
          ...
          <cfif attributes.articleID eq 140>
          <cfinclude template="/article/voting/index.cfm" />
          <cfelseif attributes.articleID eq 142>
          <cfinclude template="/article/voting/count/index.cfm" />
          </cfif>
          <!--- end special feature--->
...
$("#testZone").slideBox({width: "100%", height: optionHeight, position: "top"});
});
</script> 
<script type="text/javascript" src="/js/fontsize.js"></script> 
<script type="text/javascript" src="http://business.nd.edu/shadowbox/shadowbox.js"></script> 
