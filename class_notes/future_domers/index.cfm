...
Description: ND Business Magazine - Future Domers
 --->
 <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Notre Dame Business Magazine - Future Domers</title>
...
<cfset variables.thisarticletypeID = 15 />
...
<!--- make page object queries --->
<cfset variables.thisNoteType = "10" >
          ...
          <cfif gettabcontent.recordcount neq 0>
            ...
            <cfoutput>
              <cfloop query="gettabcontent">
                <li <cfif gettabcontent.recordcount eq gettabcontent.currentrow>class="last"</cfif>> <a href="/article/#gettabcontent.articleID#/#gettabcontent.urlslug#?classnotes=15">#gettabcontent.headline#</a> </li>
              </cfloop>
            </cfoutput>
            <li class="bottom">&nbsp;</li>
            <cfelse>
