...
Description: ND Business Magazine In Memoriam
 --->
 <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Notre Dame Business Magazine - In Memoriam</title>
...
<cfset variables.thisarticletypeID = 16 />
...
<!--- make page object queries --->
<cfset variables.thisNoteType = "11" >
              ...
              <cfif variables.thisnoteid neq pagequery.classnotesID>
                ...
                <div class="listingwrapper">
                  <cfif variables.thisheadervalue neq pagequery.classyear>
                    <div class="notesHeader"><cfif val(pagequery.classyear) neq 0>&##8217;#right(pagequery.classyear,2)#<cfelse><img src="/images/icons/nd_34x30.png" width="34" height="30" /></cfif></div>
                  ...
                  <h5>#pagequery.firstname#
                    ...
                    #pagequery.lastname# <cfif trim(pagequery.degreedetail) neq ''>(#pagequery.degreedetail#)</cfif></h5>
                  <!---handle images--->
          ...
          <cfif gettabcontent.recordcount neq 0>
            ...
            <cfoutput>
              <cfloop query="gettabcontent">
                <li <cfif gettabcontent.recordcount eq gettabcontent.currentrow>class="last"</cfif>> <a href="/article/#gettabcontent.articleID#/#gettabcontent.urlslug#?classnotes=16">#gettabcontent.headline#</a> </li>
              </cfloop>
            </cfoutput>
            <li class="bottom">&nbsp;</li>
            <cfelse>
