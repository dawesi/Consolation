...
<style>
	...
	div.vote-text {margin-top: 11px;}
	.idea-image {float: left; margin: 0 5px 5px 0;}
	#ideas p, #ideas div{padding-bottom:5px;}
	div.idea-votes {clear:both;}
	#ideas hr { height: 0; border-style:double; border-width: 1px 0 0 0; border-color:
#ccc; }
